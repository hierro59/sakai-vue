        ...
        >
            ...
            <Column :exportable="false" style="min-width: 12rem">
                <template #body="slotProps">
                    ...
                    <Button icon="pi pi-trash" outlined rounded severity="danger" class="mr-2" @click="confirmDeleteMember(slotProps.data)" v-if="slotProps.data.status !== 'inactive'" v-tooltip.top="'Delete from community'" />
                </template>
            </Column>
        </DataTable>
